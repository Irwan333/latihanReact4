            ...
            <Fragment className="contenthome">
                <div className="container">
                    <div className="slidercontent">
                            <img className="imageslider" src={require('../../../gambar/banner-desktop.jpg')} />
                    </div>
                </div>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-4">
                            <img className="imagesliderr" src={require('../../../gambar/21cineplex.jpg')} />
                            <div className="contentimage">
                                <h2 className="fontimage">www.21cineplex</h2>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <img className="imagesliderr" src={require('../../../gambar/bpn.jpg')} />
                            <div className="contentimage">
                                <h2 className="fontimage">www.bpn.go.id</h2>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <img className="imagesliderr" src={require('../../../gambar/republika.jpg')} />
                            <div className="contentimage">
